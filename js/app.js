...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  let myProduct = multiply(testDynamicArray[0], testDynamicArray[1])[0];
  let Product2 = multiply(myProduct, testDynamicArray[2])[0];
  let Product3 = multiply(Product2, testDynamicArray[3])[0];
  let finalProduct = multiply(Product3, testDynamicArray[4])[0];
  let myStr = `The numbers ${testDynamicArray[0]},${testDynamicArray[1]},${testDynamicArray[2]},${testDynamicArray[3]},${testDynamicArray[4]} have a product of ${finalProduct}.`;
  return [finalProduct, myStr];
